({
    doInit : function (component, event) {
        ...
        var action = component.get("c.getSellerProjectQuoteLines");
    ...
    downloadSellersSquawksCsv : function(component,event,helper){
        ...
        hiddenElement.download = projName + ' Sellers Squawks Report.csv';  
