({
    ...
    sortJobCard: function(component, event, helper) {
        ...
        component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'Job_Card__c'); 
    ...
    sortDescription: function(component, event, helper) {
        component.find("box3").set("v.value", false);
        component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'Job_Card_Description_Section__c'); 
       	helper.sortHelper(component, event, 'Job_Card_Description_Section__c');
    },
    
    sortLaborCost: function(component, event, helper) {
       	component.find("box3").set("v.value", false);
       	component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'Labor_Amount__c'); 
    ...
    sortFirmPriceLabor: function(component, event, helper) {
        component.find("box3").set("v.value", false);
        component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'IsFirmPriceLabour__c'); 
    ...
    sortMaterialCost: function(component, event, helper) {
    	component.find("box3").set("v.value", false);
       	component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'Material_Amount__c'); 
    ...
    sortFirmPriceMaterial: function(component, event, helper) {
		component.find("box3").set("v.value", false);
       	component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'IsFirmPriceMaterial__c'); 
    ...
    sortRTS: function(component, event, helper) {
       	component.find("box3").set("v.value", false);
       	component.set("v.selectedCount", 0);
       	component.set("v.selectedTabsoft", 'IsRTS__c'); 
	...
	getSquawks : function(component, event, helper) {
        ...
        component.find("box3").set("v.value", false);
        component.set("v.selectedTabsoft", null);
        component.set("v.selectedCount", 0);
