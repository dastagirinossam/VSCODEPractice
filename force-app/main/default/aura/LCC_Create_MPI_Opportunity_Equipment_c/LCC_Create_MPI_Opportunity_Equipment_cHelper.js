                ...
                createRecordEvent.setParams({
                   "entityApiName": "Opportunity","recordTypeId": recordTypeId,
                        "defaultFieldValues": {
                            ...
                            'SubType__c':'TFE731 - MPI',
                            'LeadSource' : 'SFDC Next Maintenance Event Calculation',
                            'Tier_Level__c' : '3',
                            'CloseDate' : wrpRec.euipRec.MPI_Oppty_Close_Date__c,
                            'InputDate__c' : wrpRec.euipRec.Next_MPI_Date__c,
                            'OutputDate__c' : wrpRec.euipRec.MPI_Oppty_Output_Date__c,
                            'StageName' : 'New Opportunity',
                            'RSM__c' : wrpRec.euipRec.RSM__c,
                            'Aircraft__c' : wrpRec.euipRec.Aircraft__c,
                           //'SubType2__c' : wrpRec.euipRec.MPI_Sub_Type_2__c
